...
RUN pythons="python2.3 python2.4 python2.5 python2.6 python3.1 python3.2 python3.3 python3.4 python3.5 python3.6 python3.7" \
 && apt-get -q update \
...
RUN curl -OsS https://bootstrap.pypa.io/get-pip.py \
 && versions="2.6 2.7 3.3 3.4 3.5 3.6 3.7" \
